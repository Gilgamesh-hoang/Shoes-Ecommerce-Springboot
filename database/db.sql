...
-- Dumping data for table shoe_project.categories: ~7 rows (approximately)
...
-- Dumping data for table shoe_project.product_sizes: ~50 rows (approximately)
...
-- Dumping data for table shoe_project.users: ~2 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `user_name`, `password`, `email`, `full_name`, `otp`, `phone_number`, `role`, `created_at`, `is_deleted`) VALUES
	(1, 'a', '$2a$12$9szEjqLykjaQVvPTnccyRuPLqAfBwCUMRNut8OECjLXLS4HW0LyiG', 'a', NULL, NULL, NULL, 'ADMIN', '2024-04-25 23:39:56', 0),
